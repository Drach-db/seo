...
Back Office changes implemented within 48 hours without disruptions [/callout]  `} />
    ...
    <DecorativeBackground className="py-16 md:py-20 lg:py-24">
      ...
      <TextBlock rawHtml={`/n Before → After Comparison /n [table]
